...
// Hazard trait categories from PF2e/SF2e
const traitCategories = {
  mechanism: {
    label: 'Mechanism',
    items: [
      'mechanical', 'magical', 'tech', 'complex',
  ...
  damage: {
    ...
    items: [
      ...
      'force', 'vitality', 'void', 'spirit',
      'poison', 'disease', 'radiation'
    ]
  },
  mental: {
    label: 'Mental & Sensory',
    items: [
      'mental', 'fear', 'emotion', 'visual', 'auditory',
      'olfactory', 'illusion', 'curse'
    ]
  },
  physical: {
    label: 'Physical',
    items: [
      'environmental', 'water', 'air', 'earth',
      'fungus', 'plant', 'steam', 'lava'
    ]
  },
  haunt: {
    label: 'Haunt & Spirit',
    items: [
      'haunt', 'incorporeal', 'divine', 'occult',
  ...
  effect: {
    ...
    items: [
      'incapacitation', 'sleep', 'polymorph',
      'teleportation', 'conjuration', 'transmutation'
    ]
  }
}
...
function addCustom() {
  const item = customTrait.value.trim().toLowerCase()
      ...
      <div v-if="isOpen" class="picker-overlay" @click="isOpen = false">
        <div class="picker-popover" @click.stop>
          <div class="popover-header">
            <span class="popover-title">Select Hazard Traits</span>
            <button type="button" class="btn-close" @click="isOpen = false">x</button>
          </div>
