...
const customSense = ref('')

// Sense categories based on GM Core and SF2e rules
...
function addCustom() {
  const item = customSense.value.trim()
...
const knownItems = computed(() => {
  ...
  for (const cat of Object.values(senseCategories)) {
      ...
      <div v-if="isOpen" class="picker-overlay" @click="isOpen = false">
        <div class="picker-popover" @click.stop>
          <div class="popover-header">
            <span class="popover-title">Select Senses</span>
            <button type="button" class="btn-close" @click="isOpen = false">×</button>
          </div>

          <div class="popover-body">
            <div
              v-for="(category, key) in senseCategories"
              :key="key"
              class="item-category"
            >
            ...
            <div class="item-category">
              ...
              <div class="custom-input-row">
                <input
                  ...
                  placeholder="Add custom sense..."
                  @keydown.enter.prevent="addCustom"
                />
                <button
                  type="button"
                  class="btn btn-secondary btn-sm"
                  :disabled="!customSense.trim()"
                  @click="addCustom"
                >
                  Add
                </button>
