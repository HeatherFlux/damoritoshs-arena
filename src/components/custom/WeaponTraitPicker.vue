...
// Weapon trait categories from PF2e/SF2e
const traitCategories = {
  accuracy: {
    label: 'Accuracy & Handling',
    items: [
      'agile', 'finesse', 'forceful', 'parry', 'sweep', 'twin',
      'backswing', 'deadly d6', 'deadly d8', 'deadly d10', 'deadly d12',
      'fatal d8', 'fatal d10', 'fatal d12'
    ]
  },
  range: {
    label: 'Range & Reach',
    items: [
      'reach', 'thrown 10 feet', 'thrown 20 feet', 'thrown 30 feet',
      'volley 30 feet', 'propulsive', 'range increment 30 feet',
      'range increment 60 feet', 'range increment 100 feet'
    ]
  },
  damage: {
    label: 'Damage Types',
    items: [
      'versatile B', 'versatile P', 'versatile S',
      'nonlethal', 'jousting d6'
    ]
  },
  special: {
    ...
    items: [
      ...
      'backstabber', 'razing', 'hampering'
    ]
  },
  tech: {
    label: 'Tech & Ranged',
    items: [
      'tech', 'analog', 'automatic', 'blast',
      'scatter 5 feet', 'scatter 10 feet',
      'unwieldy', 'free-hand', 'attached'
    ]
  },
  energy: {
    label: 'Energy & Magic',
      ...
      <div v-if="isOpen" class="picker-overlay" @click="isOpen = false">
        <div class="picker-popover" @click.stop>
          <div class="popover-header">
            <span class="popover-title">Select Weapon Traits</span>
